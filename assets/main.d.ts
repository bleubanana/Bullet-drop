...
declare const I18N: {
    readonly sv: {
        ...
        readonly movingTarget: "Rörligt mål / framförhållning";
        readonly movingTargetHelp: "Separat framförhållning utifrån kulans flygtid. Påverkar inte drop-tabellen.";
        readonly targetSpeed: "Målhastighet";
        readonly targetAngle: "Målvinkel";
        readonly movingTargetLead: "■ RÖRLIGT MÅL";
        readonly movingTargetLeadHelp: "Framförhållning = målets sidofart × kulans flygtid.";
        readonly noLead: "Mot/från";
        readonly halfLead: "Halv sidokomponent";
        readonly fullLead: "Full sidokomponent";
        ...
        readonly bulletLength: "Kullängd";
        readonly stabilityFactor: "SG";
        readonly spinRpm: "Spinn";
        readonly stabilityUnstable: "Instabil";
        readonly stabilityMarginal: "Marginal";
        readonly stabilityAcceptable: "Acceptabel";
        ...
        readonly firingDirection: "Skjutriktning";
        readonly firingDirectionNote: "0° = norr, 90° = öst, 180° = syd, 270° = väst.";
        readonly coriolisCorrection: "■ CORIOLIS";
        readonly coriolisHelp: "Approximation från jordrotation. Horisontellt visas positivt som höger; vertikalt positivt som hög träff.";
        readonly horizontalRight: "Höger";
        readonly vertical: "Vertikal";
        readonly noLatitude: "Latitud saknas — hämta platsväder eller ange manuellt.";
    };
    readonly en: {
        ...
        readonly movingTarget: "Moving target / lead";
        readonly movingTargetHelp: "Separate lead estimate from bullet time of flight. Does not change the drop table.";
        readonly targetSpeed: "Target speed";
        readonly targetAngle: "Target angle";
        readonly movingTargetLead: "■ MOVING TARGET";
        readonly movingTargetLeadHelp: "Lead = target cross speed × bullet time of flight.";
        readonly noLead: "Toward/away";
        readonly halfLead: "Half lateral";
        readonly fullLead: "Full lateral";
        ...
        readonly bulletLength: "Bullet length";
        readonly stabilityFactor: "SG";
        readonly spinRpm: "Spin";
        readonly stabilityUnstable: "Unstable";
        readonly stabilityMarginal: "Marginal";
        readonly stabilityAcceptable: "Acceptable";
        ...
        readonly firingDirection: "Direction of fire";
        readonly firingDirectionNote: "0° = north, 90° = east, 180° = south, 270° = west.";
        readonly coriolisCorrection: "■ CORIOLIS";
        readonly coriolisHelp: "Earth-rotation approximation. Horizontal is positive right; vertical is positive high.";
        readonly horizontalRight: "Right";
        readonly vertical: "Vertical";
        readonly noLatitude: "Latitude missing — load local weather or enter it manually.";
    };
};
...
export declare const __appVersion = "1.4.12";
